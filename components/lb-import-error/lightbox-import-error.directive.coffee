...
#
# File: lightbox-import-error.directive.coffee
###
...
decorator = ($delegate) ->
    ...
    directive.templateUrl = "compile-modules/tuesmon-contrib-subscriptions/components/lb-import-error/lightbox-import-error.html"
