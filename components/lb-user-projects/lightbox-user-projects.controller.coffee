...
#
# File: lightbox-user-projects.controller.coffee
###

module = angular.module('subscriptions')

class LightboxUserProjectsController
    @.$inject = [
...
module.controller("ContribLbUserProjectsController", LightboxUserProjectsController)
