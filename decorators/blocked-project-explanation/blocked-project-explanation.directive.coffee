...
decorator = ($delegate) ->
    ...
    controller = ($translatePartial) ->
        $translatePartial.addPart('tuesmon-contrib-subscriptions')

    directive.controller = ["$translatePartialLoader", controller]

    directive.templateUrl = "compile-modules/tuesmon-contrib-subscriptions/decorators/blocked-project-explanation/blocked-project-explanation.html"
