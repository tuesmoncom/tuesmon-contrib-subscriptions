...
decorator = ($delegate) ->
    ...
    directive.templateUrl = "compile-modules/tuesmon-contrib-subscriptions/decorators/create-project-members-restrictions/create-project-members-restrictions.html"
