...
class TuesmonAppControler
    ...
    _loadMetas: () ->
        sectionTitle = @translate.instant("TUESMON_APP.TITLE")
        description = @translate.instant("TUESMON_APP.SECTION_NAME")
        @.sectionName = @translate.instant("TUESMON_APP.SECTION_NAME")
...
module.controller("TuesmonAppController", TuesmonAppControler)
